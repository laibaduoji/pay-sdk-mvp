var PaySdk = (function (exports) {
  ...
  function buildAlchemyPayRequest(input) {
    ...
    if ((_a = risk == null ? void 0 : risk.forter) == null ? void 0 : _a.token)
      businessParams.cookie = risk.forter.token
    if ((_b = risk == null ? void 0 : risk.checkout) == null ? void 0 : _b.deviceSessionId)
      businessParams.checkoutCookie = risk.checkout.deviceSessionId
    const request = {
  ...
  function applyGooglePayTestDefaults(params) {
    ...
    const merchantInfo2 = {
      ...params.merchantInfo,
      merchantId:
        ((_a = params.merchantInfo) == null ? void 0 : _a.merchantId) ||
        GOOGLE_PAY_TEST_DEFAULTS.merchantId,
      merchantName:
        ((_b = params.merchantInfo) == null ? void 0 : _b.merchantName) ||
        GOOGLE_PAY_TEST_DEFAULTS.merchantName
    }
    const allowedPaymentMethods = (params.allowedPaymentMethods || []).map((method) => {
      ...
      const parameters = {
        ...spec.parameters,
        gateway:
          ((_a2 = spec.parameters) == null ? void 0 : _a2.gateway) ||
          GOOGLE_PAY_TEST_DEFAULTS.gateway,
        gatewayMerchantId:
          ((_b2 = spec.parameters) == null ? void 0 : _b2.gatewayMerchantId) ||
          GOOGLE_PAY_TEST_DEFAULTS.gatewayMerchantId
      }
      return {
        ...method,
  ...
  function merchantInfo(config) {
    ...
    const info = {
      merchantName:
        (gp == null ? void 0 : gp.merchantName) ||
        (config.environment === 'TEST' ? GOOGLE_PAY_TEST_DEFAULTS.merchantName : 'Merchant')
    }
    const merchantId =
      (gp == null ? void 0 : gp.merchantId) ||
      (config.environment === 'TEST' ? GOOGLE_PAY_TEST_DEFAULTS.merchantId : void 0)
  ...
  function getPaymentsClient(config) {
    ...
    const client = new google.payments.api.PaymentsClient(clientOptions)
  ...
  function buildGoogleBaseRequest(config) {
    ...
    return {
      ...
      allowedPaymentMethods: (request == null ? void 0 : request.allowedPaymentMethods) || [
        buildCardPaymentMethod(config)
      ]
    }
  }
  ...
  async function payWithGoogle(config) {
    ...
    try {
      ...
      if (pending.authorizedResult) {
        try {
          await ((_a = config.onSuccess) == null
            ? void 0
            : _a.call(config, pending.authorizedResult))
        } catch (err) {
...
apple-pay-button {
  ...
  function payWithApple(config) {
    ...
    if (!(ap == null ? void 0 : ap.validateMerchant)) {
      ;(_a = config.onError) == null
        ? void 0
        : _a.call(config, new Error('Apple Pay merchant validation is not configured'))
      return
    }
    const riskPromise = resolveRiskCollection(config)
  ...
  class PayApiClient {
    ...
    async createOrder(request) {
      const data = await this.request(this.config.createOrderUrl, 'POST', request)
  ...
  function resolvePayApiConfig(environment, overrides) {
    ...
    return {
      ...
      createOrderUrl:
        (overrides == null ? void 0 : overrides.createOrderUrl) || defaults.createOrderUrl,
      validateMerchantUrl:
        (overrides == null ? void 0 : overrides.validateMerchantUrl) ||
        defaults.validateMerchantUrl,
      payUrl: (overrides == null ? void 0 : overrides.payUrl) || defaults.payUrl,
      queryOrderUrl:
        (overrides == null ? void 0 : overrides.queryOrderUrl) || defaults.queryOrderUrl,
  ...
  function e(e2, t2) {
    return (Array.isArray(e2) ? e2 : [e2]).map((e3) =>
      (function (e4, t3) {
  ...
  function n(e2) {
    ...
    try {
      o2 = (function (e3, t2, n3) {
        ...
        const i2 = 1 + t2.length,
          a2 = g(o3[i2], o3[0])
        o3.length < i2 + 1 + a2 + n3 && r2()
        const s2 = i2 + 1 + a2,
          l2 = s2 + n3,
          u2 = new ArrayBuffer(o3.length - l2),
          d2 = new Uint8Array(u2)
    ...
    try {
      return (function (e3) {
        const n3 = { len: 0, arr: new Uint8Array(128) },
          o3 = c(e3)
        let a2 = 0
        const s2 = () => (
            R2(),
    ...
    ;(!(function (e3, t3, n2) {
      ...
      (function (e3, t3) {
        ...
        try {
          null ===
            (n2 =
              null === localStorage || void 0 === localStorage ? void 0 : localStorage.setItem) ||
            void 0 === n2 ||
            n2.call(localStorage, e3, t3)
        } catch (r2) {}
      })(t2, e2))
  }
  function i(e2) {
  ...
  function c(e2) {
    return e2 instanceof ArrayBuffer
      ? new Uint8Array(e2)
      : new Uint8Array(e2.buffer, e2.byteOffset, e2.byteLength)
  }
  function a({ level: e2, message: t2 }) {
    'error' === e2 ? console.error(t2) : 'warning' === e2 ? console.warn(t2) : console.log(t2)
  }
  const s = 'Client timeout',
    l = 'Network connection error',
    u = 'Network request aborted',
    d = 'Response cannot be parsed',
    f = 'Blocked by CSP',
    R = 'The endpoint parameter is not a valid URL',
    E = 'Handle on demand agent data error'
  var h = '3.12.13'
  const p = 'Failed to load the JS script of the agent',
    _ = '9319'
  function O(e2, t2) {
    if (e2.arr.length < t2) {
  ...
  const I = 'https://fpnpmcdn.net/v<version>/<apiKey>/loader_v<loaderVersion>.js',
    w = I
  function g(e2, t2) {
    ...
    return [
      ...
      (e3, o2) => {
        ...
        if (c2 === f || c2 === R) (t2.exclude(), (i2 = 0))
          ...
          const n3 = Date.now() - e3.getTime() < 50,
            o3 = t2.current()
  ...
  const A = { default: 'endpoint' },
    N = { default: 'tlsEndpoint' },
    S = '_vid'
  function D(e2, t2, n2, r2) {
    const o2 = document,
      i2 = 'securitypolicyviolation'
    let c2
    const a2 = (t3) => {
      const n3 = new URL(e2, location.href),
        { blockedURI: r3 } = t3
  ...
  function P(t2) {
    ...
    const { picked: o2, rest: i2 } = (function (e2, t3) {
      ...
      })(t2, ['scriptUrlPattern', 'token', 'apiKey']),
      c2 = o2.token,
      a2 = null !== (n2 = o2.apiKey) && void 0 !== n2 ? n2 : c2,
      s2 =
        null !==
          (r2 = (function (e2, t3) {
            return Object.prototype.hasOwnProperty.call(e2, t3)
          })((l2 = t2), (u2 = 'scriptUrlPattern'))
            ? l2[u2]
            : void 0) && void 0 !== r2
          ? r2
          : I
    ...
    const [d2, f2] = (function () {
      const e2 = [],
        ...
        n3 =
          ...
          (o3 = 'visibilitychange'),
          (i3 = t3),
          r3.addEventListener(o3, i3, c3),
          () => r3.removeEventListener(o3, i3, c3))
      var r3, o3, i3, c3
      return (t3(), [e2, n3])
    })()
    return Promise.resolve()
  ...
  const C = 34,
    ...
    W = 123,
    z = 125,
    J = /* @__PURE__ */ new Uint8Array([110, G, 108, 108]),
    Q = /* @__PURE__ */ new Uint8Array([116, 114, G, F]),
    Z = /* @__PURE__ */ new Uint8Array([102, 97, 108, 115, F]),
    ee = { '"': '"', '\\': '\\', '\b': 'b', '\f': 'f', '\n': 'n', '\r': 'r', '	': 't' },
    te = /* @__PURE__ */ (() => {
    ...
    ne = /* @__PURE__ */ Oe('WrongRegion'),
    re = /* @__PURE__ */ Oe('SubscriptionNotActive'),
    oe = /* @__PURE__ */ Oe('UnsupportedVersion'),
    ie = /* @__PURE__ */ Oe('InstallationMethodRestricted'),
    ce = /* @__PURE__ */ Oe('HostnameRestricted'),
    ae = /* @__PURE__ */ Oe('IntegrationFailed'),
    se = /* @__PURE__ */ Oe('NetworkRestricted'),
    le = /* @__PURE__ */ Oe('InvalidProxyIntegrationSecret'),
  ...
  const Re = /The document is sandboxed and lacks the 'allow-same-origin' flag/,
    Ee = /The operation is insecure/,
    he = /Forbidden in a sandboxed document without the 'allow-same-origin' flag/
  function pe(e2, t2, n2, r2) {
    v(
      () => {
        const o2 = `${e2}=${t2}`,
          i2 = `expires=${new Date(Date.now() + 24 * n2 * 60 * 60 * 1e3).toUTCString()}`,
          c2 = r2 ? `domain=${r2}` : ''
        ...
        return (
          [
            ...
            'MozAppearance' in
              (null !==
                (t3 =
                  null === (e3 = document.documentElement) || void 0 === e3 ? void 0 : e3.style) &&
              void 0 !== t3
                ? t3
                : {}),
            'onmozfullscreenchange' in n3,
            'mozInnerScreenX' in n3,
            'CSSMozDocumentRule' in n3,
            'CanvasCaptureMediaStream' in n3
          ].reduce((e4, t4) => e4 + (t4 ? 1 : 0), 0) >= 4
        )
      })()
    ;(function (e3, t3) {
      let n3 = e3.length - ('.' === e3.slice(-1) ? 1 : 0)
      do {
        if (((n3 = n3 > 0 ? e3.lastIndexOf('.', n3 - 1) : -1), true === t3(e3.slice(n3 + 1))))
          return true
      } while (n3 >= 0)
      return false
    })(t2, (r2) => {
  ...
  function we() {
    ...
    if (
      ((function (e3, t3) {
        var n3
        const r2 =
          null === (n3 = Object.getOwnPropertyDescriptor) || void 0 === n3
            ? void 0
            : n3.call(Object, e3, t3)
        ;(null == r2 ? void 0 : r2.configurable)
          ? delete e3[t3]
          : (r2 && !r2.writable) || (e3[t3] = void 0)
      })(e2, t2),
      'function' != typeof (null == n2 ? void 0 : n2.load))
    )
      throw new Error(_)
    return n2
  }
  ...
  const ye = function (e2, t2 = {}) {
      ...
      try {
        const t3 = n(e2)
        null !== t3
          ? (t3.visitorToken && o(t3.visitorToken, `${r2}_t`),
            null == (c2 = t3.notifications) || c2.forEach(a),
            T(i2, () => ({ e: 25, result: { response: t3 } })))
          : T(i2, () => ({ e: 25, result: { error: new Error('Failed to decode response') } }))
      } catch (s2) {
        throw (
          T(i2, () => ({
            e: 25,
            result: { error: s2 instanceof Error ? s2 : new Error(String(s2)) }
          })),
          (function (e3, t3, n2) {
    ...
    Te = 'API key required',
    Ae = 'API key not found',
    Ne = 'API key expired',
    Se = 'Request cannot be parsed',
    De = 'Request failed',
    be = 'Request failed to process',
    Pe = 'Too many requests, rate limit exceeded',
    Ce = 'Not available for this origin',
    Ue = 'Not available with restricted header',
    Le = Te,
    Me = Ae,
    xe = Ne
  var ke = {
    load: P,
    defaultScriptUrlPattern: w,
    ERROR_SCRIPT_LOAD_FAIL: p,
    ERROR_API_KEY_EXPIRED: Ne,
    ERROR_API_KEY_INVALID: Ae,
    ERROR_API_KEY_MISSING: Te,
    ERROR_BAD_REQUEST_FORMAT: Se,
    ERROR_BAD_RESPONSE_FORMAT: d,
    ERROR_CLIENT_TIMEOUT: s,
    ERROR_CSP_BLOCK: f,
    ERROR_FORBIDDEN_ENDPOINT: ce,
    ERROR_FORBIDDEN_HEADER: Ue,
    ERROR_FORBIDDEN_ORIGIN: Ce,
    ERROR_GENERAL_SERVER_FAILURE: De,
    ERROR_HANDLE_AGENT_DATA: E,
    ERROR_INSTALLATION_METHOD_RESTRICTED: ie,
    ERROR_INTEGRATION_FAILURE: ae,
    ERROR_INVALID_ENDPOINT: R,
    ERROR_INVALID_PROXY_INTEGRATION_HEADERS: ue,
    ERROR_INVALID_PROXY_INTEGRATION_SECRET: le,
    ERROR_NETWORK_ABORT: u,
    ERROR_NETWORK_CONNECTION: l,
    ERROR_NETWORK_RESTRICTED: se,
    ERROR_PROXY_INTEGRATION_SECRET_ENVIRONMENT_MISMATCH: de,
    ERROR_RATE_LIMIT: Pe,
    ERROR_SERVER_TIMEOUT: be,
    ERROR_SUBSCRIPTION_NOT_ACTIVE: re,
    ERROR_TOKEN_EXPIRED: xe,
    ERROR_TOKEN_INVALID: Me,
    ERROR_TOKEN_MISSING: Le,
    ERROR_UNSUPPORTED_VERSION: oe,
    ERROR_WRONG_REGION: ne,
    defaultEndpoint: A,
    defaultTlsEndpoint: N,
    handleAgentData: ye
  }
  ...
  function runtimeConfigFromOrder(config, order, api, onWalletAuthorized, onAuthorizePay) {
    ...
    return {
      ...
      billingAddressRequired:
        (((_a = paymentScript.requiredBillingContactFields) == null ? void 0 : _a.length) || 0) > 0,
      applePay: {
        validateMerchantUrl,
  ...
  class PaySdk2 {
    ...
    buildApiConfig(environment) {
      ...
      return resolvePayApiConfig(environment, {
        ...this.config.api,
        paymentHubToken:
          ((_a = this.api) == null ? void 0 : _a.getPaymentHubToken()) ||
          ((_b = this.config.order) == null ? void 0 : _b.token),
    ...
    async prepare() {
      ...
      if (!this.runtimeConfig) {
        ...
        void Promise.all([this.fingerprintIdPromise, this.runtimeConfig.riskCollection]).then(
          ([fingerprintId, risk]) => {
            var _a2, _b2
            ;(_b2 = (_a2 = this.config).onRiskCollected) == null
              ? void 0
              : _b2.call(_a2, {
    ...
    complete(walletResult, paymentResponse, order) {
      ...
      this.paymentInFlight = false
      this.earlyPayPromise = null
      ;(_c = (_b = this.config).onComplete) == null
        ? void 0
        : _c.call(_b, {
            ...walletResult,
            orderNo: (_a = this.order) == null ? void 0 : _a.orderNo,
