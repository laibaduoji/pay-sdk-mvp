var PaySdk = (function (exports) {
  ...
  function mergeFingerprintConfig(cfg) {
    ...
    return {
      ...
      scriptUrlPattern: (
        (_a = cfg == null ? void 0 : cfg.scriptUrlPattern) == null ? void 0 : _a.length
      )
        ? cfg.scriptUrlPattern
        : FINGERPRINT_DEFAULTS.scriptUrlPattern,
      endpoint: ((_b = cfg == null ? void 0 : cfg.endpoint) == null ? void 0 : _b.length)
        ? cfg.endpoint
  ...
  function mergeSiteId(cfg) {
    return ((cfg == null ? void 0 : cfg.siteId) || FORTER_DEFAULTS.siteId).trim()
  }
  ...
  async function payWithGoogle(config) {
    ...
    try {
      ...
      ;(_a = config.onSuccess) == null
        ? void 0
        : _a.call(config, { ...normalizeGoogleResult(paymentData), risk })
    } catch (err) {
